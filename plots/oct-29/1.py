...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-29\\10k_f_path4.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(",")
...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-29\\10k_f_path4_comp.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(" ")
...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-29\\10kf_tree_only.log") as f:
    skip = 0
    old = 0
    i = 0
    for line in f:
...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-29\\10kf_tree_only_comp.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(" ")
...
#     lines.append(temp[i])
#
with open('10k_f_4.csv', 'wb') as writeFile:
