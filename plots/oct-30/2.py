...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-30\\10kf_psa.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(",")
...
with open("C:\Users\Beast\Documents\IISc\Research\logs\oct-30\\10kf_psa_comp.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(" ")
...
#     lines.append(temp[i])
#
with open('10k_f.csv', 'wb') as writeFile:
