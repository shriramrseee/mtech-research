...
nos = {'query_3': 3, 'query_4': 2, 'query_5': 2, 'query_6': 3, 'query_7': 4}
query_comp = {}
comp = {}

with open("C:\Users\Beast\Documents\IISc\Research\logs\\nov-26\\100k_zf_100_cm2.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(",")
...
with open("C:\Users\Beast\Documents\IISc\Research\logs\\nov-26\\100k_zf_100_cm2_comp.log") as f:
    skip = 0
    old = 0
    for line in f:
        l = line[:-1].split(" ")
...
#     lines.append(temp[i])
#
with open('100k_zf_100_cm.csv', 'wb') as writeFile:
